...
- [berenm/gdk-pixbuf-loader-apng](https://github.com/berenm/gdk-pixbuf-loader-apng) - GDK Pixbuf Loader for APNG animations
...
- [supertone-inc/supertonic](https://github.com/supertone-inc/supertonic) - Lightning-Fast, On-Device TTS — running natively via ONNX.
...
- [OpenIXCLab/SeC](https://github.com/OpenIXCLab/SeC) - SeC: Advancing Complex Video Object Segmentation via Progressive Concept Construction
...
- [IceClear/SeedVR2](https://github.com/IceClear/SeedVR2) - SeedVR2: One-Step Video Restoration via Diffusion Adversarial Post-Training
...
- [devmobasa/wayscriber](https://github.com/devmobasa/wayscriber) - Live overlay for drawing, annotating with zoom, hiding text, and capturing screenshots on Linux. Can be used as whiteboard or blackboard. Highly customisable.
...
- [hcavarsan/pipedash](https://github.com/hcavarsan/pipedash) - Manage CI/CD pipelines from multiple providers (self hosted and desktop app)
...
- [mapi68/raspi-info](https://github.com/mapi68/raspi-info) - RASPI-INFO: Your Raspberry Pi Swiss Army Knife for System Information
...
- [RookieEnough/Orion-Store](https://github.com/RookieEnough/Orion-Store) - The ultimate home for modded apps. OrionStore offers instant access to YouTube ReVanced, Spotify Premium, and essential open-source tools without the clutter. No servers, no tracking, just a beautiful
...
- [educlopez/smoothui](https://github.com/educlopez/smoothui) - SmoothUI is a collection of beautifully designed components with smooth animations built with React, Tailwind CSS, and Motion
...
- [Bytez-com/docs](https://github.com/Bytez-com/docs) - 1 API key. 175,000+ servereless AI models.
