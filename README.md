...
- [Shiro836/waydroid-nvidia](https://github.com/Shiro836/waydroid-nvidia) - GPU-accelerated Waydroid on the nvidia-open/nvidia-open-dkms driver
...
- [mapache-soft/Unarchiver](https://github.com/mapache-soft/Unarchiver) - Git mirror of The Unarchiver
...
- [michaelgrieco/cmathematics](https://github.com/michaelgrieco/cmathematics) - Mathematics library for C and C++
...
- [ozone10/7zip-Dark7zip](https://github.com/ozone10/7zip-Dark7zip) - Dark mode for 7-Zip
...
- [nbcraft-org/mcped](https://github.com/nbcraft-org/mcped) - The Minecraft PE (mcpe01_canada.apk) Decompilation Project
...
- [ragnarokxg/VivalArc](https://github.com/ragnarokxg/VivalArc) - With just a few tweaks, you can give Vivaldi that cool Arc vibe
...
- [bitscoper/bitscoper_cyberkit](https://github.com/bitscoper/bitscoper_cyberkit) - A Flutter Application: Bluetooth Low Energy Scanner, IPv4 Subnet Scanner, mDNS Scanner, UPnP Scanner, Route Tracer, TCP Port Scanner, Pinger, DNS Record Retriever, File Hash Calculator, String Hash Ca
- [SaltyAom/niku](https://github.com/SaltyAom/niku) - Compose Flutter UI from utilities Widget and extensions with dot cascade. Fluently developing without headache and Nested Hell.
- [Senzme/NFile](https://github.com/Senzme/NFile) - A Beautiful File Manager
- [Nandanrmenon/florid](https://github.com/Nandanrmenon/florid) - F-Droid Client
- [adeeteya/Awake-AlarmApp](https://github.com/adeeteya/Awake-AlarmApp) - Awake is a customizable alarm application built with Flutter. Set repeating alarms, choose fun ways to dismiss them and fine‑tune every aspect of how they ring.
...
- [Far-Se/tabame](https://github.com/Far-Se/tabame) - Tabame is an alternative to Windows Taskbar. It's Raycast and Powertoys combined.
...
- [pgrundev/pgbook](https://github.com/pgrundev/pgbook) - Postgres Book, one topic at a time.
...
- [link-society/flowg](https://github.com/link-society/flowg) - Low Code / Visual Scripting log processing software
- [akihiro/wsl-secret-service](https://github.com/akihiro/wsl-secret-service) - 
- [pgrundev/pgbot](https://github.com/pgrundev/pgbot) - Postgres intelligence for ai agents & apps
- [Calnode/calnode](https://github.com/Calnode/calnode) - Lean, self-hostable Calendly & Cal.com alternative — a single Go binary + SQLite, API-first and MCP-native. Apache-2.0.
...
- [kanlaya5/BasicThemer5](https://github.com/kanlaya5/BasicThemer5) - The most lightweight basic themer yet.
...
- [THE-TECH-CHANGER/NothingButtonRemapper](https://github.com/THE-TECH-CHANGER/NothingButtonRemapper) - 
...
- [Shrey113/App-Scrcpy](https://github.com/Shrey113/App-Scrcpy) - A scrcpy-inspired Android screen, audio, and control streaming client for Windows — built without ADB, using pure WebSocket communication.
...
- [parcoillegacy/nativegames.net-v1](https://github.com/parcoillegacy/nativegames.net-v1) - Nativegames - Free Unblocked Games - Opensource
...
- [CyberGuides/SMS-API](https://github.com/CyberGuides/SMS-API) - SMS API demo for textbelt.
...
- [arm-education/Embedded-Linux-Education-Kit](https://github.com/arm-education/Embedded-Linux-Education-Kit) - Education kit for teaching embedded Linux system design and development on Arm-based platforms with lectures and labs (educational)
- [arm-education/Introduction-to-Computer-Architecture-Education-Kit](https://github.com/arm-education/Introduction-to-Computer-Architecture-Education-Kit) - Education kit for teaching computer architecture with a 5-stage Arm-based Verilog core and hands-on labs (educational)
...
- [floci-io/floci-cli](https://github.com/floci-io/floci-cli) - Any Cloud. Locally. Floci CLI to manage local cloud emulators.
- [floci-io/floci-oci](https://github.com/floci-io/floci-oci) - Light, fluffy, and always free - Local Oracle Cloud Emulator
...
- [floci-io/floci-gcp](https://github.com/floci-io/floci-gcp) - Light, fluffy, and always free - GCP Local Emulator
...
- [everyx/gnome-shell-extension-window-nativizer](https://github.com/everyx/gnome-shell-extension-window-nativizer) - A GNOME Shell extension. Seamlessly nativize non-native applications into the GNOME desktop.
- [VaZark/appindicator-quicksetting](https://github.com/VaZark/appindicator-quicksetting) - Show the AppIndicator item in the Gnome's QuickSettings dropdown
- [bilawalsidhu/gods-eye-view](https://github.com/bilawalsidhu/gods-eye-view) - A spy satellite simulator in your browser, except the data is real. Live open source spatial intelligence on a photorealistic 3D globe.
- [ivanusto/unmark-web](https://github.com/ivanusto/unmark-web) - Independent browser-first client that strips invisible Unicode marks and C2PA/EXIF/XMP/ID3 metadata from text, images, audio and video locally, or via the watermarks-remover Python service (MIT)
...
- [smartfoloo/lunarsync](https://github.com/smartfoloo/lunarsync) - This project has been archived. For a more updated and maintained proxy, check out arsenic.
...
- [cesar-cipher/Python-Hand-Gesture-Recognition](https://github.com/cesar-cipher/Python-Hand-Gesture-Recognition) - A guide to using Python and OpenCV2 to create an application that can recognize hand gestures/movements.
...
- [bikram-agarwal/FilePipe](https://github.com/bikram-agarwal/FilePipe) - Turn messy Android storage into a rule-driven library: choose sources, filters, destinations, and schedules, then let the app manage it for you.
...
- [Zanuaimi/UniPatches](https://github.com/Zanuaimi/UniPatches) - Curated list of universal patches for Morphe, including community-driven patches with enhancements and original patches, focusing on quality over quantity
...
- [NikhilKain/stride](https://github.com/NikhilKain/stride) - Material 3 Expressive step counter for Android
...
- [arnesacnussem/jellyfin-documents-provider](https://github.com/arnesacnussem/jellyfin-documents-provider) - Use Poweramp with Jellyfin
...
- [1372Slash/Zenith](https://github.com/1372Slash/Zenith) - A Material Design 3 Expressive Digital Wellbeing App
...
- [saad-khan-rind/NOSAtmosphereEffect](https://github.com/saad-khan-rind/NOSAtmosphereEffect) - Atmosphere Effect by Nothing for Android Devices on Android 13+
...
- [roozbehzarei/filester](https://github.com/roozbehzarei/filester) - Temporary cloud storage for fast, private file sharing
...
- [Varun7009/Obsidian-Music](https://github.com/Varun7009/Obsidian-Music) - 🌌 Obsidian Music: A premium, beautifully crafted local music player for Android. Built with Jetpack Compose, ExoPlayer, and stunning modern aesthetics🎧✨
...
- [sabino-pereira/Modern_Arch_Linux_Install](https://github.com/sabino-pereira/Modern_Arch_Linux_Install) - A comprehensive guide to installing Arch Linux with all of the modern features.
...
- [d34dinsid3k1tty/windows-on-linux](https://github.com/d34dinsid3k1tty/windows-on-linux) - 🖥️ Run Windows(-only) programs on Linux
...
- [mr-j90/windows_11_emojis](https://github.com/mr-j90/windows_11_emojis) - 😜☁️⛅⛈️🌪️ This is an ongoing collection of the new Windows 11 Emoji set. Please note that these are PNG images and not editable SVGs. The emojis list will be updated with time. I am not associated with
...
- [fromhgbwithluv/SAB](https://github.com/fromhgbwithluv/SAB) - A PoC of StartAllBack's licensing mechanism
...
- [IshuSinghSE/aurynk](https://github.com/IshuSinghSE/aurynk) - Wirelessly connect, manage and control your Android devices from Linux ✨
- [rylena/sshdesk](https://github.com/rylena/sshdesk) - A full interactive remote desktop delivered entirely through SSH and displayed directly in your terminal.
...
- [hackclub/podium](https://github.com/hackclub/podium) - Podium is Hack Club's open-source peer-judging platform for hackathons
...
- [Hunyuan-PromptEnhancer/PromptEnhancer](https://github.com/Hunyuan-PromptEnhancer/PromptEnhancer) - [CVPR 2026] PromptEnhancer is a prompt-rewriting tool, refining prompts into clearer, structured versions for better image generation.
...
- [zjx0101/ObjectClear](https://github.com/zjx0101/ObjectClear) - [CVPR'26] ObjectClear: Precise Object and Effect Removal with Adaptive Target-Aware Attention
- [microsoft/DAViD](https://github.com/microsoft/DAViD) - 
- [FujiwaraChoki/MoneyPrinter](https://github.com/FujiwaraChoki/MoneyPrinter) - Automate Creation of YouTube Shorts using MoviePy.
- [scottvr/wtffmpeg](https://github.com/scottvr/wtffmpeg) - A minimal character terminal (console) REPL UI for controlling ffmpeg via natural language descriptions of input files and the desired outcome, powered by local or remote LLM. Shell-style history with
...
- [jishnu-kv/WinUI-3-Apps-List](https://github.com/jishnu-kv/WinUI-3-Apps-List) - A curated collection of over 800+ apps that embrace the WinUI 3 Design
...
- [jlevy/repren](https://github.com/jlevy/repren) - Power rename/refactor tool for CLI and agent use
...
- [jlu5/icoextract](https://github.com/jlu5/icoextract) - icon extractor for Windows executables (.exe/.dll/.mun)
...
- [iBug/This-Repo-Has-628-Stars](https://github.com/iBug/This-Repo-Has-628-Stars) - Yes, it's true :gift_heart: This repository has 628 stars.
...
- [cutefishos/fishui](https://github.com/cutefishos/fishui) - Cutefish GUI library, based on Qt Quick
...
- [rust-ui/ui](https://github.com/rust-ui/ui) - A Shadcn-inspired component registry for Rust. Build cross-platform apps for Web, Desktop, iOS and Android.
...
- [rust-man-org/rustman](https://github.com/rust-man-org/rustman) - Free, open-source API testing desktop app built with Rust. No account, no cloud, no telemetry.
...
- [deep-gaurav/warden-worker-new](https://github.com/deep-gaurav/warden-worker-new) - A Bitwarden-compatible server for Cloudflare Workers
...
- [cmjcode/tabular](https://github.com/cmjcode/tabular) - Your Query Client, Forged with Rust: Fast, Safe, Efficient.
...
- [aerium-browser/aerium-browser-android](https://github.com/aerium-browser/aerium-browser-android) - Secure, lightweight and open-source Android browser with extension support
- [dbprohq/db-pro](https://github.com/dbprohq/db-pro) - Query, explore, and manage your databases with a beautiful desktop app, collaborative web platform, and built-in AI.
...
- [katsumi-neko/Linux-Mint-Debloater](https://github.com/katsumi-neko/Linux-Mint-Debloater) - Script to debloat Linux Mint
...
- [DaniGuardiola/pico-cn](https://github.com/DaniGuardiola/pico-cn) - slower but smaller cn
...
- [TheRealYT/git-knife](https://github.com/TheRealYT/git-knife) - 
...
- [tonyedgal/spaceman-react-theme-animation](https://github.com/tonyedgal/spaceman-react-theme-animation) - React framework-agnostic UI theming library with animated theme transitions. Supports Nextjs, Tanstack, Vite etc
...
- [bird-networks/aero](https://github.com/bird-networks/aero) - A safe, developer-friendly, declarative interception web proxy with many features with a powerful web sandboxing library to bypass and overcome browser limitations in a secure sandbox that respects se
...
- [AtomsDevs/Atoms](https://github.com/AtomsDevs/Atoms) - Terminal-first desktop frontend for persistent Linux environments.
