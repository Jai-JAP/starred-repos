...
- [BalajeS/WSL-For-FreeBSD](https://github.com/BalajeS/WSL-For-FreeBSD) - Experimental project to adapt the WSL2 open-source components to run on FreeBSD
...
- [openuiai/next.js](https://github.com/openuiai/next.js) - 
