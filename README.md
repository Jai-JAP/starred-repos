...
- [royalgraphx/DarwinKVM](https://github.com/royalgraphx/DarwinKVM) - An advanced guide to run Mac OS / OS X / macOS on QEMU/KVM with libvirtd/Virt-Manager. Includes various write-ups for deep customization.
